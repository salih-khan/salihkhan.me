...
<div class="home">
       ...
       <div class="s3__outer">
            <div class="s3">
                ...
                <div class="s3_grid_container">
                    <div class="s3_card" @click="goToSite('/projects/loomverse')">
                        <img src="../assets/Images/bt.png" alt="">
                        <h1>Loomverse (ongoing Development)</h1>
                        <p>A platform where Multi-Choice stories are brought to life by adding interactivity
                            with options and animations.
                        </p>
                    </div>
                    <div class="s3_card">
    ...
    <div class="footer">
        <p style="color: black;">&copy; salihkhan.me</p>
    </div>
</div>
</template>
...
.s3__outer {
    background: url('../assets/Images/grid_black.jpg');
